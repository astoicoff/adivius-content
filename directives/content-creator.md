...
## Rules
- Follow and adhere to the given instructions unless being told otherwise. 
- Maintain clarity and logical flow between paragraphs.
- Use shorter sentences, unless told otherwise. Try not to pass 20 words for a sentence.
- Avoid writing sentences that are hard to read by separating them into two sentences (but only if it makes sense).   
- One paragraph should have 2-3 sentences, unless told otherwise. 
