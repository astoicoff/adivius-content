            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="phase1Form">
                        ...
                        <!-- Optional reference image — picked BEFORE prompt generation so the
                             prompt-engineer knows whether it's writing edit instructions -->
                        <div class="form-group" style="margin-bottom:16px;">
                            ...
                            <div style="font-size:11px;color:var(--text-muted);margin-top:5px;">When attached, the prompt is written as edit instructions for this image rather than a from-scratch scene</div>
                        </div>
